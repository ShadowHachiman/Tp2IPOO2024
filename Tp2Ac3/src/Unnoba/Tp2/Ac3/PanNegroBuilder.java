...
public class PanNegroBuilder implements PanBuilder {
    ...
    public PanNegro getPanNegro() {
        return this.panNegro;
    }

    public PanNegro getProducto() {
        PanNegro product = getPanNegro();
        reset();
        return product;
    }
}
